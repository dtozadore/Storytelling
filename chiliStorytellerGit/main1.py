...
# Trying to execute one file from inside this one
# import subprocess
# subprocess.run(["python3", "connection_from_website.py"])  # On Windows, use 'python' or 'python3'
# with open("connection_from_website.py") as file:
#     exec(file.read())


# Crete saving directory
directory_name = "index_files"
...
class StorytellingApp:
    ...
    def __init__(self):
        ...
        try:
            ...
            raise Exception("Robot not identified. Please run teh robot's node first.")
